    ...
    <li><a>Publisher year</a></li>
      ...
      <Tabs>
        ...
        <TabPanel>
          {/* read list tabs */}
          <div className="my-10">
            {readList.length === 0 && <h2 className="md:w-2/5 mx-auto text-4xl/normal font-bold text-center my-40">You haven’t added any books to your Read list yet.</h2>}
            {readList?.map((book) => (
        ...
        <div className="my-10">
          {
            wishList.length === 0 && <h2 className="md:w-2/5 mx-auto text-4xl/normal font-bold text-center my-40">You haven’t added any books to your Wish list yet.</h2>
          }
          {
            wishList?.map((book)=>
